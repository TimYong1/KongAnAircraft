...
public final class ToastUtil {
    ...
    public static void showWarningDebug(CharSequence content) {
    ...
    public static void showFailedDebug(CharSequence content, CharSequence releaseCharSequence) {
        if (AppConfig.DEBUG_BODE) {
            showFailed(content);
        }else {
            showFailed(releaseCharSequence);
        }
    }
    ...
    public static void showNormalCondition(CharSequence debugContent,CharSequence content ) {
        if (AppConfig.DEBUG_BODE) {
            showNormal(debugContent);
        }else {
            showNormal(content);
        }
    }
    ...
    private static void showCustomLayout(int layout, CharSequence content) {
        checkContext();
        if (isMainThread()) {
            showCustom(layout, content);
        } else {
            mHandler.post(() -> showCustom(layout, content));
        }
    }

    private static void showCustom(int layout, CharSequence content) {
        new Builder(mApp)
                .setDuration(Toast.LENGTH_SHORT)
                .setFill(false)
                .setGravity(Gravity.CENTER)
