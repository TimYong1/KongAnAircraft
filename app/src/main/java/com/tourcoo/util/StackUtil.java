 ...
 * @description :
 * @company :途酷科技
 * @date 2020年10月28日16:43
 * @Email: 971613168@qq.com
 */
public class StackUtil {
    private final String TAG ="StackUtil";
    ...
    public StackUtil pop(Activity activity, boolean isFinish) {
        if (activity != null) {
            Log.i(TAG, "remove current activity:" + activity.getClass().getSimpleName() + ";isFinishing" + activity.isFinishing());
