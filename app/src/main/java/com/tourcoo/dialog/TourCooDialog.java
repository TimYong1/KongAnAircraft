...
public class TourCooDialog {
    ...
    public TourCooDialog(Context context) {
    ...
    public TourCooDialog init() {
        ...
        container.setLayoutParams(
                new FrameLayout.LayoutParams(
                        (int) (display.getWidth() * 0.4),
                        LinearLayout.LayoutParams.WRAP_CONTENT));

        return this;
    }

    public TourCooDialog setTitle(String title) {
        showTitle = true;
        if ("".equals(title)) {
            titleTv.setText("标题");
        } else {
    ...
    public TourCooDialog setMsg(String msg) {
        showMsg = true;
        if ("".equals(msg)) {
            msgTv.setText("内容");
        } else {
    ...
    public TourCooDialog setCancelable(boolean cancel) {
        dialog.setCancelable(cancel);
        return this;
    }

    public TourCooDialog setPositiveButton(String text,
    ...
    public TourCooDialog setNegativeButton(String text, final View.OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            negBtn.setText("取消");
        } else {
