 ...
 * @description :
 * @company :途酷科技
 * @date 2021年05月18日11:50
 * @Email: 971613168@qq.com
 */
public class VideoSeekBar extends androidx.appcompat.widget.AppCompatSeekBar {
    /**
     * 定义一个展现时间的PopupWindow
     */
    final private PopupWindow mPopupWindow;

    final private View mView;
    /**
     * 显示时间的TextView
     */
    final  private TextView dialogSeekTime;
    /**
    ...
    public VideoSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        mView = LayoutInflater.from(context).inflate(R.layout.seek_popu_layout, null);
