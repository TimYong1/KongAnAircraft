...
public final class ThreadPool implements Executor {
    ...
    private ThreadCallback defCallback;// default thread callback
    ...
    private ThreadPool(int type, int size, int priority, String name, ThreadCallback callback, Executor deliver, ExecutorService pool) {
        if (pool == null) {
     ...
     * @return EasyThread
     */
    public ThreadPool setName(String name) {
     ...
     * @return EasyThread
     */
    public ThreadPool setCallback(ThreadCallback callback) {
     ...
     * @return EasyThread
     */
    public ThreadPool setDelay(long time, TimeUnit unit) {
     ...
     * @return EasyThread
     */
    public ThreadPool setDeliver(Executor deliver) {
    ...
    public static class Builder {
        ...
        public ThreadPool build() {
            ...
            return new ThreadPool(type, size, priority, name, callback, deliver, pool);
        }
    }
