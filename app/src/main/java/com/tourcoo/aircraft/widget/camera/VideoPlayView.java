 ...
 * @description :
 * @company :途酷科技
 * @date 2021年06月08日15:02
 * @Email: 971613168@qq.com
 */
public class VideoPlayView extends LinearLayout implements MediaManager.VideoPlaybackStateListener {
                        ...
                        if (djiError == null) {
                            ...
                            if (null != mediaManager) {
                                if (mediaManager.isVideoPlaybackSupported()) {
                                    mediaManager.addMediaUpdatedVideoPlaybackStateListener(VideoPlayView.this);
                                }
                            }
