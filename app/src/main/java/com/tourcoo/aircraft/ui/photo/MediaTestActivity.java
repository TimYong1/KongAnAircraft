...
public class MediaTestActivity extends Activity implements View.OnClickListener {
    ...
    protected void onDestroy() {
      ...
      CameraHelper.getInstance().getCamera().setMode(SettingsDefinitions.CameraMode.SHOOT_PHOTO, new CommonCallbacks.CompletionCallback() {
                @Override
...
//                Toast.makeText(this, result, Toast.LENGTH_SHORT).show();
    ...
    private void initMediaManager() {
        if (ProductManager.getProductInstance() == null) {
            ...
            if (null !=CameraHelper.getInstance().getCamera()&& CameraHelper.getInstance().getCamera().isMediaDownloadModeSupported()) {
                mMediaManager = CameraHelper.getInstance().getCamera().getMediaManager();
                if (null != mMediaManager) {
                    mMediaManager.addUpdateFileListStateListener(this.updateFileListStateListener);
                    mMediaManager.addMediaUpdatedVideoPlaybackStateListener(this.updatedVideoPlaybackStateListener);
                    CameraHelper.getInstance().getCamera().setMode(SettingsDefinitions.CameraMode.MEDIA_DOWNLOAD, new CommonCallbacks.CompletionCallback() {
                        @Override
            ...
            } else if (null != CameraHelper.getInstance()
                    && !CameraHelper.getInstance().getCamera().isMediaDownloadModeSupported()) {
